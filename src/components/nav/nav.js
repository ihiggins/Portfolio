...
function movePage(element){
  ...
  toggleNav()
    ...
    return (
      <div>
        <div id='burger' class="menu-icon" onClick={() => { toggleNav() }}>
...
<div class="nav">
	<div class="nav__content">
		<ul class="nav__list">
			<li class="nav__list-item" onClick={() => { movePage('landing') }} >Home</li>
			<li class="nav__list-item"onClick={() => { movePage('about') }}>About</li>
			<li class="nav__list-item"onClick={() => { movePage('experience') }}>Experience</li>
		</ul>
	</div>
</div>
      </div>
